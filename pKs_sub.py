...
from MyAMI.gammaANDalpha_sub import CalculateGammaAndAlphas
import MyAMI.K_thermo_conditional
import MyAMI.K_HSO4_thermo
import MyAMI.gammaNeutral
...
def calculate_Ks(Tc,Sal, mCa, mMg):
    ...
    [gamma_cation, gamma_anion, alpha_Hsws, alpha_Ht, alpha_OH, alpha_CO3] = CalculateGammaAndAlphas(Tc,Sal,I,m_cation,m_anion)
    ...
    [KspCcond, K1cond, K2cond, Kwcond, Kbcond, KspAcond, K0cond, KHSO4cond] = MyAMI.K_thermo_conditional.CalculateKcond(Tc,Sal)
    [KspC,K1, K2, Kw, Kb, KspA, K0, KHSO4] = MyAMI.K_thermo_conditional.CalculateKthermo(Tc,Sal)
    
    # moved to "K_thermo_cond"[KHSO4cond, KHSO4] = K_HSO4_thermo.supplyK(Tc+273.15,I,Sal)#*(gamma_anion[4]/gamma_anion[6]/gamma_cation[0])
    [gammaCO2, gammaCO2gas, gammaB] = MyAMI.gammaNeutral.gammaCO2(Tc, m_anion, m_cation)
