...
if (INTERACTIVE == 1) or (INTERACTIVE == -1):
    ...
    print "(#4): Salinity is taken to be a master variable, determining (1) ionic strngth according to I = 19.924*Sal/(1000-1.005*Sal); and (2) determining the dilution/concentration of the dissolved species according to Conc(Sal=X) = Conc(Sal=35) * X/35."
    print
    print "USAGE:"
...
def func_K0((TempK,Sal), a, b, c, d, e, f):
...
def func_K1((TempK,Sal), a, b, c, d, e):
...
def func_K2((TempK,Sal), a, b, c, d, e):
...
def func_Kb((TempK,Sal), a, b, c, d, e, f, g, h, i, j, k, l):
...
def func_Kw((TempK,Sal), a, b, c, d, e, f, g):
    sqrtSal = numpy.sqrt(Sal)
    lnTempK = numpy.log(TempK)
...
def func_KspC((TempK,Sal), a, b, c, d, e, f, g, h, i):
    sqrtSal = numpy.sqrt(Sal)
...
def func_KspA((TempK,Sal), a, b, c, d, e, f, g, h, i):
    sqrtSal = numpy.sqrt(Sal)
    log10TempK = numpy.log10(TempK)
...
def func_KSO4((TempK,Sal), a, b, c, d, e, f, g, h, i, j, k):
