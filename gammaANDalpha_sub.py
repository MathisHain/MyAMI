...
from MyAMI.PitzerParams import SupplyParams
from MyAMI.K_HSO4_thermo import supplyK as supplyKS
from MyAMI.K_HF_cond import supplyK as supplyKF
...
def CalculateGammaAndAlphas(Tc,S,I,m_cation,m_anion):
    ...
    #######################################################################################
    [beta_0, beta_1, beta_2, C_phi, Theta_negative, Theta_positive, Phi_NNP, Phi_PPN, C1_HSO4] = SupplyParams(T)
...
#print CMX[4,:], "CMX"
    ...
    [K_HSO4_conditional, K_HSO4] = supplyKS(T,I,S)#*(gamma_anion[4]/gamma_anion[6]/gamma_cation[0])
    ...
    alpha_Hsws = 1/(1+ m_anion[6]/K_HSO4_conditional + 0.0000683/(supplyKF(T,sqrtI)))
